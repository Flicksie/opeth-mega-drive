...
{
    0x0211,     // 0 : #112 // #223 - black 
    0x0733,     // 1 : #337 - dark gray 
    0x0EBA,     // 2 : #ABE - light gray 
    0x05CE,     // 3 : #EEF - white 

    0x0213,     // 4 : #312 - dark red 
    0x083A,     // 5 : #A38 - red 

    0x0611,     // 6 : #116 - dark blue 
    0x0A32,     // 7 : #23A - blue 

    0x0420,     // 8 : #024 - dark blue/cyan 
    0x0A36,     // 9 : #36A - blue/cyan 

    0x0320,     // A : #045 - dark cyan 
    0x0DB0,     // B : #0BD - cyan 

    0x0111,     // C : #121 - dark green 
    0x08A2,     // D : #2A8 - green 

    0x0346,     // E : #643 - dark yellow 
    0x05CE      // F : #EC5 - yellow 
};
...
static void preparePlayerState(u16 i){
...
static void drawTrackInfo()
{
    ...
    else
    {
        ...
        if (len > 30)
        {
            strncpy(str, trackInfo->trackName, min(len, 30-1));
            strcat(str, ".");
        }
...
static void drawZ80Load()
{
    ...
    fillColumnZ80(h1, h2, c1, c2, 0x44444444);
}
