...
const u16 gfx_palette[16] =
{
    ...
    0x0633,     // 1 : #336 - dark gray 
    0x0FAA,     // 2 : #AAF - light gray 
    0x0F55,     // 3 : #EEF - white 

    0x0208,     // 4 : #802 - dark red 
    0x083F,     // 5 : #F38 - red 

    0x0400,     // 6 : #004 - dark blue 
    0x0F32,     // 7 : #23F - blue 

    0x0420,     // 8 : #024 - dark blue/cyan 
    0x0F63,     // 9 : #36F - blue/cyan 

    0x0450,     // A : #054 - dark cyan 
    0x0EC0,     // B : #0CE - cyan 

    0x0240,     // C : #042 - dark green 
    0x08E2,     // D : #2E8 - green 
